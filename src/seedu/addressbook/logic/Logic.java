...
public class Logic {
    ...
    private CommandResult execute(Command command) throws Exception {
    	command.setData(addressBook, lastShownList);
    	         ...
    	         try{
    	        	 result= command.execute();//returns type of either addCommand/ClearCommand... (all subtypes that implement command as given in the parser class). These subtypes have an execute method the in turn returns result of CommandResult type. 
    	         }
